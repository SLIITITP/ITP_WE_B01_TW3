    ...
    function filterData(employees, searchKey) {
      const result = employees.filter((employee) => {
        return (
          ...
          employee.contactNum.includes(searchKey) ||
...
<div className="container shadow-lg p-3 mb-5  rounded" style={{background:"#04052e"}}>
        ...
        <tr key={index}>
          ...
          <td>
            <div className="btn-group" role="group">
              <a className="btn btn-success" href={`/emupdate/${employee._id}`}>
  ...
  <button className="btn btn-danger btn-lg">
    <a href="/emadd" style={{ textDecoration: "none", color: "white" }}>Monthly End Reset</a>
  </button>
</div>
